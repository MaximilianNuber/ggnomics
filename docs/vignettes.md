...
* [Home](https://yourname.github.io/ggnomics/vignettes/index.html) — landing
...
[`vignettes/datasets.yml`](https://github.com/yourname/ggnomics/blob/main/vignettes/datasets.yml)
