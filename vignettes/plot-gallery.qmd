...
`bulk_pca.plot_pca` is demonstrated in full in [Bulk RNA-seq §7](bulk-rnaseq.qmd#7-pca-on-the-vst-transformed-expression).
...
[Multimodal](multimodal.qmd#5-rna-qc-and-adt-qc).
...
[Single-cell analysis §11](single-cell-scranpy.qmd#11-heatmap),
[Bulk RNA-seq §10](bulk-rnaseq.qmd#10-heatmap-of-top-differentially-expressed-genes),
...
* `plot_adt_qc` requires annotated isotype controls. The CITE-seq panel used
  here does not contain them; [Multimodal §5](multimodal.qmd#5-rna-qc-and-adt-qc)
