...
[Section 13](#13-native-plot_pseudobulk_demode-upset)) is `padj < 0.05` and
...
above are 0-2 genes. [Section 13](#13-native-plot_pseudobulk_demode-upset)
...
see the callout in [Section 15](#15-statistical-helper-caution).
...
[Section 2](#2-data-source-and-selection-rule):
...
* [API reference](../api/upset/) — full signatures for every function used
  above.
