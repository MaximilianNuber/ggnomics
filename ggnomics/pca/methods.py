...
def run_pca_sklearn(data: np.ndarray, n_components: int = 50, **kwargs) -> PcaResult:
    ...
    return PcaResult(scores=scores, loadings=loadings, explained_variance_ratio=explained_variance, model=pca)
...
def run_pca_svd(data: np.ndarray, n_components: int = 50) -> PcaResult:
    ...
    return PcaResult(scores=scores, loadings=loadings, explained_variance_ratio=explained_variance_ratio, model=None)
