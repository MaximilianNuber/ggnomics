...
def marker_dotplot(
    ...
    """
    Placeholder for marker dot-plot (genes × groups). Implementation to be added.
    """
    raise NotImplementedError("marker_dotplot will be implemented in a future module.")
